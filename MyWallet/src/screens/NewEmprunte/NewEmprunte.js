...
const NewEmprunte = () => {
    ...
    const newDebt = () => {
        if (!nam) {
            ...
            const payload = {
                name: nam, description: description, budget: budget, type: "EMPRUNTE", amount: solde, date: data.date, dueDate: data.duedate
    ...
    return (
        <View style={styles.container}>
            <View style={{ flex: 0.1, justifyContent: 'center' }}>
                ...
                />
                <Text style={{ color: '#FFF', alignSelf: 'center', fontSize: 18, fontWeight: '700' }}>J'ai emprunté</Text>
                <AntDesign
                    name="check"
                    size={28}
                    style={{
            ...
            <ScrollView style={styles.footer}>
                <View style={styles.view}>
                    ...
                    <CustomInput
                        placeholder={'a qui avez-vous emprunté ?'}
                        value={nam}
                        setValue={(nam) => setNam(nam)}
                        error={err.n}
                    />
                </View>
                <View style={styles.view}>
